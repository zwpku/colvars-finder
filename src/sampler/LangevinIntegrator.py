...
def calc_weights(sys_temp, sampling_temp, csv_filename, traj_weight_filename):

    # use potential energy in the csv file generated by OpenMM code
    print (f'\n=============Calculate Weights============')
    print (f'sampling temperature: {sampling_temp}, system temperature: {sys_temp}')
    ...
    # select the (1st) column containing potential energy 
    energy_col_idx = 1
...
# +
print ( 'trajectory ouptuts will be saved under: %s' % sampling_path)
...
calc_weights(sys_temp, sampling_temp, csv_filename, traj_weight_filename)
